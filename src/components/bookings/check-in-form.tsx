...
import { checkIn } from "@/app/actions/bookings";
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Capture your location and a photo to start this job.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              {photoUrl && (
                <img src={photoUrl} alt="Check-in preview" className="size-full max-h-48 rounded-lg object-cover" />
              )}
            </div>
